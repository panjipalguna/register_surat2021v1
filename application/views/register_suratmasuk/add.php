    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Register Suratmasuk Add</h3>
            </div>
            <?php echo form_open('register_suratmasuk/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="tanggal_masuk" class="control-label">Tanggal Masuk</label>
						<div class="form-group">
							<input type="text" name="tanggal_masuk" value="<?php echo $this->input->post('tanggal_masuk'); ?>" class="has-datepicker form-control" id="tanggal_masuk" />
						</div>
					</div>
					<div class="col-md-6">
